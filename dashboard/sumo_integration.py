...
try:
    # First try to import standard SUMO traci
    import traci
    
    # Then try our custom modules
    sys.path.insert(0, SUMO_PATH)  # Insert at beginning to prioritize
    ...
    SUMO_AVAILABLE = True
    print(f"✅ Real SUMO modules loaded successfully from {SUMO_PATH}!")
